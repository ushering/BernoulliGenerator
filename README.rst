...
For :math:`p=0.5`, the length of its binary expansion :math:`n=1`, and thus the expected number of flips is :math:`1`. For :math:`p=0.625`, i.e., :math:`n=3`, the expected number of flips is :math:`1.75`. When :math:`n\rightarrow\infty`, e.g., :math:`p=5/7`, the expected number of flips will be :math:`2`.